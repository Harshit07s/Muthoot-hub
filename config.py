...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002328571656"))
...
USER_REPLY_TEXT = os.environ.get("USER_REPLY_TEXT", "❌ 𝙿𝚕𝚎𝚊𝚜𝚎 𝙰𝚟𝚘𝚒𝚍 𝙳𝚒𝚛𝚎𝚌𝚝 𝙼𝚎𝚜𝚜𝚊𝚐𝚎𝚜. 𝙸'𝚖 𝚆𝚘𝚛𝚔𝚒𝚗𝚐 𝙵𝚘𝚛 𝙾𝚗𝚕𝚢  @unfiltered_team")

#your bot token here from https://telegram.me/BotFather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7464406395:AAH91om8WA9QskmEMwnT0IuIbVecpTw0HEk") 
...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002194855220"))
...
SHORTLINK_API_KEY = os.environ.get("SHORTLINK_API_KEY", "d085b925c2b0bafde56a5729a018f45655ad9602")
...
TUT_VID = os.environ.get("TUT_VID","https://t.me/Tutorial_Cute_Heaven/3")
...
#UPI ID
UPI_ID = os.environ.get("UPI_ID", "secret080@axl")
#UPI QR CODE IMAGE
UPI_IMAGE_URL = os.environ.get("UPI_IMAGE_URL", "https://graph.org/file/81dc15c16633b25bea05b-cc2bb434ccb79a032c.jpg")
...
#6 Month
PRICE4 = os.environ.get("PRICE4", "ask owner")
#1 Year
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "1371770132 7645440087").split()):
        ADMINS.append(int(x))
except ValueError:
